...
public class PriorityJobFragment extends Fragment {

    private EditText emailInput, category;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_priority_job, container, false);

        AdView adView = root.findViewById(R.id.adViewJobpriority);
        ...
        category = root.findViewById(R.id.jobCategoryInputlist);
        ...
        submitBtn.setOnClickListener(v -> {
            ...
            if (email.isEmpty()) {
                ...
                pendingCategory = category.getText().toString();

                showLoadingDialog("Loading ad, please wait...");
                Toast.makeText(getContext(), "Priority Job Application Submitted!", Toast.LENGTH_LONG).show();
    ...
    public void SendInforToServer(String emailInput, String careerInput) {
        ...
        RequestBody formBody = new FormBody.Builder()
                .add("type", "Priority Job Application")
                .add("days", "0")
                .add("name", "")
        ...
        RewardedAd.load(requireContext(), TEST_AD_UNIT_ID_REWARDED, adRequest,
                new RewardedAdLoadCallback() {
                    ...
                    public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                        ...
                        SendInforToServer(pendingEmail, pendingCategory);
                    }
                });
    }
